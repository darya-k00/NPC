...
NOTIFICATION='this is global constant'
...
def main():
    ...
    for skill in runic_skills:
        ...
        selected_skills = random.sample(skill,3)
    ...
    for i in range(10):
       ...
       file_operations.render_template("charsheet.svg", "C:/result/result_{}.svg".format(i+1), context)
